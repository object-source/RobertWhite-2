...
class Webshopapps_Wsacommon_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public static function getVersion() {
		...
		if (version_compare($version, '1.6', '>=')) {
            ...
            else if (version_compare($version, '1.14') >= 0) $eeVersion = 1.14;
            ...
            else if (version_compare($version, '1.8') >= 0 && !self::isEnterpriseEdition()) $eeVersion = 1.14;  //CE 1.9, EE 1.14
	...
	public static function getNewVersion() {
		...
		if (version_compare($version, '1.6', '>=')) {
            ...
            else if (version_compare($version, '1.9') >= 0 && !self::isEnterpriseEdition()) $eeVersion = 14;  //CE 1.9, EE 1.14
