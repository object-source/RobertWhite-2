 ...
 */
class Magestore_Promotionalgift_Block_Promotionalgiftcatalog extends Mage_Catalog_Block_Product_List {
    ...
    protected function _getProductCollection() {
        return Mage::getSingleton('promotionalgift/catalogproductlayer')->getProductCollection();
    }
