...
class Geissweb_Euvatgrouper_Model_System_Config_Source_Oscintegration {
	...
	public function toArray()
	{
		return array(
			...
			'CMSMART_CHECKOUT' => Mage::helper('euvatgrouper')->__('CMSMart OneStepCheckout'),
			'MAGEMART_QUICKCHECKOUT' => Mage::helper('euvatgrouper')->__('Magemart Quickcheckout'),
			'OCODEWIRE_ONESTEPCHECKOUT' => Mage::helper('euvatgrouper')->__('Ocodewire OneStepCheckout')
		);
	}
