 ...
 */
class Magestore_Promotionalgift_Block_Promotionalcatalogpage extends Mage_Catalog_Block_Product_List {

    /**
     * prepare block's layout
     *
     * @return Magestore_Promotionalgift_Block_Promotionalgiftcatalog
     */
