 ...
 */
class Ves_Tabs_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('ves_tabs/banner_image'));
     ...
     *
     * @see ves_Slider_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return ves_Slider_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return ves_Slider_Model_Banner_Image
     */
